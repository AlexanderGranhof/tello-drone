...
module.exports.Drone = class Drone {
     ...
     * @param {Number} options.z1 - Starting z position for the curve command. Max: 500, Min: -500.
     * @param {Number} options.z2 - Ending z position for the curve command. Max: 500, Min: -500.
     */
